...
type Pemain struct {
	...
	Nama_Pemain  string             `bson:"nama_pemain,omitempty" json:"nama_pemain,omitempty"example:"haaland"`
	...
	Tanggal_Lahir primitive.DateTime `bson:"tanggal_lahir,omitempty" json:"tanggal_lahir,omitempty"swaggertype:"string" example:"2024-09-01T00:00:00Z" format:"date-time"`
	Negara       string             `bson:"negara,omitempty" json:"negara,omitempty"example:"Denmark"`
	No_Punggung   int                `bson:"no_punggung,omitempty" json:"no_punggung,omitempty"example:"9"`
}
